...
CREATE OR ALTER PROCEDURE silver.load_silver AS -- Stored Prcedure Start
BEGIN 
...
PRINT '-------------------------------------------------';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Table:  ilver.erp_PX_CAT_G1V2';
		TRUNCATE TABLE silver.erp_PX_CAT_G1V2
		PRINT '>> Inserting Data into :ilver.erp_PX_CAT_G1V2'
